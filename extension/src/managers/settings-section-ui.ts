...
export type SettingsSection = 'general' | 'clip-note' | 'properties' | 'highlighter' | 'interpreter' | 'reader' | 'templates';
	...
	if (sidebar) {
		sidebar.addEventListener('click', (event) => {
			...
			if (section === 'general'
				...
				|| section === 'interpreter'
				|| section === 'reader') {
				showSettingsSection(section as 'general' | 'clip-note' | 'properties' | 'highlighter' | 'interpreter' | 'reader');
			}
